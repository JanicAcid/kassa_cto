...
export const KASSA_CATALOG: KassaProduct[] = [
  ...
  },
  {
    ...
    features: ['ФФД 1.2 (маркировка)', 'Срок 36 месяцев', 'Для УСН/ПСН/услуг', 'Без маркировки и алкоголя'],
    type: 'autonomous', inStock: true,
    gift: '', warranty: '12 месяцев',
    specGroups: [
      { name: 'Основное', specs: [
...
export const CONFIGURATOR_OPTIONS: ConfiguratorOption[] = [
  ...
  // ─── Услуги ──────────────────────────────────────────────────────────────
  { id: 'reg-fns', name: 'Регистрация ККТ в ФНС', desc: 'Подача заявления, фискализация', price: 1500, category: 'service', badge: 'Обязательно' },
