...
export const KASSA_CATALOG: KassaProduct[] = [
  ...
  },
  {
    ...
    type: 'autonomous', inStock: true,
    gift: 'ОФД на 15 месяцев + сим-карта', warranty: '12 месяцев',
  },
  {
  ...
  },
  {
    ...
    gift: 'ОФД на 15 месяцев + 0% комиссия 1 мес', warranty: '12 месяцев',
  },
  {
    ...
    type: 'smart', hasAcquiring: true, inStock: true,
    gift: 'ОФД на 15 месяцев + 0% комиссия 2 мес', warranty: '18 месяцев',
  },
  {
    ...
    gift: 'ОФД на 15 месяцев в подарок', warranty: '12 месяцев',
  },
  {
    ...
    type: 'register', inStock: true,
    gift: 'ОФД на 15 месяцев в подарок', warranty: '18 месяцев',
  },
  {
  ...
  },
  {
    ...
    type: 'smart', inStock: true,
    gift: 'ОФД на 15 месяцев + 3 приложения', warranty: '12 месяцев',
  },
  {
    id: 'evotor-7-3', brand: 'Эвотор', model: '7.3', name: 'Эвотор 7.3',
    price: 32900, oldPrice: 39480,
    ...
    type: 'smart', inStock: true,
    gift: 'ОФД на 15 месяцев + 5 приложений', warranty: '18 месяцев',
  },
  {
    ...
    type: 'smart', inStock: true,
    gift: 'ОФД на 15 месяцев + настройка 1С', warranty: '18 месяцев',
  },
]
...
export const CONFIGURATOR_OPTIONS: ConfiguratorOption[] = [
  { id: 'fn-15', name: 'ФН на 15 месяцев', desc: 'Для маркировки, алкоголя, ОСН', price: 14900, oldPrice: 15900, category: 'fn', badge: 'Обязательно' },
  { id: 'fn-36', name: 'ФН на 36 месяцев', desc: 'Для УСН, ПСН, услуг — выгоднее', price: 20900, oldPrice: 23000, category: 'fn', badge: 'Выгоднее' },
  { id: 'ofd-15', name: 'ОФД на 15 месяцев', desc: 'В ПОДАРОК при покупке кассы', price: 0, oldPrice: 3000, category: 'ofd', badge: 'ПОДАРОК' },
  { id: 'ofd-36', name: 'ОФД на 36 месяцев', desc: 'Доплата за 3 года вместо 15 мес', price: 4000, oldPrice: 7000, category: 'ofd', badge: '-43%' },
  { id: 'reg-fns', name: 'Регистрация ККТ в ФНС', desc: 'Подача заявления, фискализация', price: 3000, category: 'service', badge: 'Обязательно' },
  { id: 'setup', name: 'Настройка кассы под ключ', desc: 'Загрузка товаров, обучение, тестовый чек', price: 3000, oldPrice: 5000, category: 'service', badge: '-40%' },
  { id: 'delivery', name: 'Доставка и установка', desc: 'Привезём, подключим, проверим', price: 600, oldPrice: 2000, category: 'service', badge: '-70%' },
