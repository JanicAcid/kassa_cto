...
export const KASSA_CATALOG: KassaProduct[] = [
  ...
  },
  {
    ...
    features: ['ФФД 1.2 (маркировка)', 'Сенсорный экран 5.5"', 'Wi-Fi + 4G', 'Android'],
  ...
  },
  {
    ...
    features: ['ФФД 1.2 (маркировка)', 'Эквайринг (Мир/Visa/MC)', 'Wi-Fi + 4G', 'Android'],
  ...
  },
  {
    ...
    features: ['ФФД 1.2 (маркировка)', 'Сенсорный экран 6"', 'Эквайринг', 'Wi-Fi + 4G'],
    type: 'smart', hasAcquiring: true, inStock: true,
    gift: 'ОФД Такском 15 мес — 2 200 ₽ вместо 6 900 ₽', warranty: '12 месяцев',
      specGroups: [
      { name: 'Основное', specs: [
  ...
  },
  {
    ...
    features: ['ФФД 1.2 (маркировка)', 'USB + RS-232', 'Ширина чека 80 мм', 'Совместимость с 1С'],
  ...
  },
  {
    ...
    features: ['ФФД 1.2 (маркировка)', 'Автоотрезчик', 'Скорость 200 мм/сек', 'Совместимость с 1С'],
    type: 'register', inStock: true,
    gift: 'ОФД Такском 15 мес — 2 200 ₽ вместо 6 900 ₽', warranty: '12 месяцев',
      specGroups: [
      { name: 'Основное', specs: [
  ...
  },
  {
    ...
    features: ['ФФД 1.2 (маркировка)', 'Автоотрезчик', 'USB + Ethernet', 'Для 1С'],
    type: 'register', inStock: true,
    gift: 'ОФД Такском 15 мес — 2 200 ₽ вместо 6 900 ₽', warranty: '12 месяцев',
      specGroups: [
      { name: 'Основное', specs: [
  ...
  },
  {
    ...
    shortDesc: 'Фискальный регистратор с автоотрезчиком',
    features: ['ФФД 1.2 (маркировка)', 'Автоотрезчик', 'USB', 'Совместимость с 1С'],
    type: 'register', inStock: true,
    gift: 'ОФД Такском 15 мес — 2 200 ₽ вместо 6 900 ₽', warranty: '12 месяцев',
      specGroups: [
      { name: 'Основное', specs: [
  ...
  },
  {
    ...
    features: ['ФФД 1.2 (маркировка)', 'Автоотрезчик (1.5 млн отрезов)', 'Скорость 300 мм/сек', 'USB + Ethernet'],
    type: 'register', inStock: true,
    gift: 'ОФД Такском 15 мес — 2 200 ₽ вместо 6 900 ₽', warranty: '12 месяцев',
      specGroups: [
      { name: 'Основное', specs: [
  ...
  },
  {
    ...
    features: ['ФФД 1.2 (маркировка)', 'Сенсорный экран 6"', 'Wi-Fi + 3G', 'Эвотор.Маркет'],
    type: 'smart', inStock: true,
    gift: 'ОФД Такском 15 мес — 2 200 ₽ вместо 6 900 ₽', warranty: '12 месяцев',
  },
  {
  ...
  },
  {
    ...
    features: ['ФФД 1.2 (маркировка)', 'Сенсорный экран 7"', '5 USB-портов', 'Аккумулятор до 14ч'],
    type: 'smart', inStock: true,
    gift: 'ОФД Такском 15 мес — 2 200 ₽ вместо 6 900 ₽', warranty: '12 месяцев',
      specGroups: [
      { name: 'Основное', specs: [
  ...
  },
  {
    ...
    features: ['ФФД 1.2 (маркировка)', 'Сенсорный экран 10.1"', '6 USB-портов', 'Wi-Fi + 4G'],
    type: 'smart', inStock: true,
    gift: 'ОФД Такском 15 мес — 2 200 ₽ вместо 6 900 ₽', warranty: '12 месяцев',
      specGroups: [
      { name: 'Основное', specs: [
  ...
  },
  {
    ...
    badge: 'Обязательно',
    shortDesc: 'Для маркировки, алкоголя, ОСН, ЕГАИС. ФФД 1.2. Срок 15 месяцев — продлить нельзя. ВАЖНО: для подакцизных товаров (алкоголь, табак, топливо) фактический срок ФН ограничен 410 днями (~13 мес) по закону 54-ФЗ.',
    features: ['ФФД 1.2 (маркировка)', 'Срок 15 месяцев', 'Для ОСН/маркировки/алкоголя', 'Подакцизные товары: 410 дней', 'Все модели касс'],
    type: 'autonomous', inStock: true,
    gift: '', warranty: '12 месяцев',
    specGroups: [
      { name: 'Основное', specs: [
        { label: 'Модель', value: 'ФН-1.2' },
        { label: 'Срок действия', value: '15 месяцев (410 дней для подакцизных)' },
        { label: 'Гарантия', value: '12 месяцев' },
      ]},
      { name: 'Применение', specs: [
        { label: 'Маркировка', value: 'Поддерживается' },
        { label: 'Алкоголь (ЕГАИС)', value: 'Поддерживается' },
        { label: 'Подакцизные товары', value: '410 дней (п. 6 ст. 4.1 54-ФЗ)' },
  ...
  },
  {
    ...
    badge: 'Выгоднее',
    shortDesc: 'Для УСН, ПСН, услуг — без маркировки и алкоголя. ФФД 1.2. Выгоднее: 3 года вместо 15 мес. ВАЖНО: для подакцизных товаров фактический срок ФН ограничен 410 днями (~13 мес) по закону 54-ФЗ — даже если установлен ФН-36.',
    features: ['ФФД 1.2', 'Срок 36 месяцев', 'Для УСН/ПСН/услуг', 'Без маркировки и алкоголя', 'Подакцизные товары: 410 дней'],
    type: 'autonomous', inStock: true,
    gift: '', warranty: '12 месяцев',
    specGroups: [
      { name: 'Основное', specs: [
        { label: 'Модель', value: 'ФН-1.2' },
        { label: 'Срок действия', value: '36 месяцев (410 дней для подакцизных)' },
        { label: 'Гарантия', value: '12 месяцев' },
      ]},
      { name: 'Применение', specs: [
