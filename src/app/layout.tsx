      ...
      >
        ...
        <noscript>
          <div style={{ padding: '16px', maxWidth: '768px', margin: '0 auto', fontFamily: 'sans-serif', fontSize: '14px', lineHeight: '1.6', color: '#334155' }}>
            ...
            <p>Центр технического обслуживания кассового оборудования в Санкт-Петербурге и Ленинградской области. ООО «Теллур-Интех» — с 1995 года. Более 5000 касс настроено, 3000+ клиентов. Подключение маркировки, регистрация ККТ, настройка Честного ЗНАК, ЭДО, ТС ПИоТ. Меркурий, Атол, Сигма, Эвотор, Штрих-М, Пионер, AQSI.</p>
