...
export const metadata: Metadata = {
  title: 'Бесплатная диагностика маркировки — проверьте настройку кассы | Теллур-Интех',
  description: 'Бесплатная диагностика маркировки за 6 вопросов. Проверьте готовность кассы к маркировке, получите план внедрения под ключ. СПб и ЛО. ЦТО с 1995 года.',
  alternates: { canonical: '/diagnostika' },
  keywords: ['диагностика маркировки', 'проверка маркировки', 'проверить кассу маркировка', 'аудит маркировки', 'диагностика кассы спб', 'готовность к маркировке', 'план внедрения маркировки'],
}
