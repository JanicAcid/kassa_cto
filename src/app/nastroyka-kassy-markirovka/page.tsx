...
const jsonLdService = {
  ...
  offers: {
    ...
    price: '1500',
    priceCurrency: 'RUB',
    description: 'Частичная настройка маркировки от 1 500 ₽, полная под ключ от 6 000 ₽',
  },
}
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Частичная настройка маркировки начинается от 1 500 ₽. Полная настройка под ключ — от 6 000 ₽.',
      },
    },
    {
      '@type': 'Question',
...
const FAQS = [
  {
    ...
    a: 'Частичная настройка маркировки начинается от 1 500 ₽. Полная настройка под ключ — от 6 000 ₽. Рассчитайте точную стоимость в нашем бесплатном <Link href="/" className="text-[#163A5F] underline underline-offset-2 hover:text-[#1E4A78]">калькуляторе</Link> — это занимает 2 минуты.',
  },
  {
