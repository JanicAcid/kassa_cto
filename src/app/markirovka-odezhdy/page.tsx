...
export const metadata: Metadata = {
  ...
  description:
    'Маркировка одежды по Data Matrix: настройка кассы, регистрация в Честном ЗНАКе, подключение ЭДО и ОФД. Цена от 1 500 ₽, срок от 1 дня. Санкт-Петербург и ЛО.',
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: 'Маркировка одежды 2025 — настройка кассы, подключение к Честный ЗНАК',
    description:
      'Полная настройка маркировки одежды под ключ: касса, Честный ЗНАК, ЭДО, ТС ПИоТ, ОФД. От 6 800 ₽, от 1 дня.',
    url: PAGE_URL,
