...
const jsonLdService = {
  ...
  offers: {
    ...
    price: '1500',
    priceCurrency: 'RUB',
    description: 'Подключение Честного ЗНАК от 1 500 ₽, полная настройка под ключ от 6 800 ₽',
  },
}
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Регистрация в Честном ЗНАКе бесплатная — это государственная система. Платная часть — настройка и подключение всех компонентов: УКЭП, настройка кабинета, привязка кассы, настройка ТС ПИоТ, обучение. Стоимость настройки от 1 500 ₽. Полная настройка под ключ — от 6 800 ₽.',
      },
    },
    {
      '@type': 'Question',
