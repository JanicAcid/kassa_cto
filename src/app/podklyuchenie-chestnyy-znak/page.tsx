...
const jsonLdService = {
  ...
  offers: {
    ...
    price: '1500',
    priceCurrency: 'RUB',
    description: 'Подключение Честного ЗНАК от 2 000 ₽, полная настройка под ключ от 6 000 ₽',
  },
}
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Регистрация в Честном ЗНАКе бесплатная — это государственная система. Платная часть — настройка и подключение всех компонентов: УКЭП, настройка кабинета, привязка кассы, настройка ТС ПИоТ, обучение. Стоимость настройки от 2 000 ₽. Полная настройка под ключ — от 6 000 ₽.',
      },
    },
    {
      '@type': 'Question',
...
const FAQS = [
  {
    ...
    a: 'Сама регистрация в Честном ЗНАКе — бесплатная, это государственная система. Платная часть — это работа специалиста по настройке всех компонентов: помощь с УКЭП, регистрация, настройка кабинета, привязка кассы, ТС ПИоТ, обучение сотрудников. Стоимость настройки начинается от 2 000 ₽, полная настройка под ключ — от 6 000 ₽. Рассчитайте точную стоимость в нашем бесплатном <Link href="/" className="text-[#163A5F] underline underline-offset-2 hover:text-[#1E4A78]">калькуляторе</Link>.',
  },
  {
