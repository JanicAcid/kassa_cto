...
const jsonLdFaq = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Бюджетные мобильные кассы (Меркурий 115Ф, Меркурий-119Ф) — от 10 900 ₽. Смарт-терминалы среднего сегмента (Эвотор 5, Атол Sigma 7Ф) — от 24 900 до 32 000 ₽. Флагманские решения (Эвотор 7.3, Атол Sigma 8Ф) — от 42 000 ₽. К цене кассы добавьте стоимость ФН (13 900–20 100 ₽) и настройку (от 2 000 ₽).',
      },
    },
    {
      '@type': 'Question',
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Бюджетные модели (Меркурий 115Ф, Меркурий-119Ф) — от 10 900 ₽. Смарт-терминалы среднего сегмента (Эвотор 5, Атол Sigma 7Ф) — от 24 900 до 32 000 ₽. Флагманские решения (Эвотор 7.3, Атол Sigma 8Ф, Pirit 2Ф) — от 42 000 ₽. К стоимости кассы добавьте: фискальный накопитель (13 900–20 100 ₽ в зависимости от срока), настройку под маркировку (от 2 000 ₽) и при необходимости внешний 2D-сканер (от 3 000 ₽). Рассчитайте точную стоимость в нашем бесплатном <Link href="/" className="text-[#163A5F] underline underline-offset-2 hover:text-[#1E4A78]">калькуляторе маркировки</Link>.',
  },
  {
