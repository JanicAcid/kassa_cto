...
const faqPage = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Стоимость настройки маркировки зависит от состояния кассы. Частичная настройка для действующей кассы — от 1 500 рублей. Полная настройка под ключ — от 6 800 рублей.',
      },
    },
    {
      '@type': 'Question',
