...
const faqPage = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Стоимость подключения маркировки зависит от состояния кассы (новая, б/у или действующая), бренда (Меркурий, Атол, Сигма, Эвотор, Штрих-М, Пионер, AQSI) и набора необходимых услуг. Используйте наш бесплатный калькулятор на сайте для точного расчёта — это занимает не более 2 минут. Частичная настройка маркировки начинается от 2 000 рублей, полная под ключ — от 6 000 рублей.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Стоимость настройки маркировки зависит от состояния кассы. Частичная настройка для действующей кассы — от 2 000 рублей. Полная настройка под ключ — от 6 000 рублей.',
      },
    },
    {
      '@type': 'Question',
